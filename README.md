...
|-------------|----------------------------------------------------------|-------------------------------------------------------------|
| **RF**      | class_weight='balanced', max_depth=4, max_samples=0.920910, min_samples_leaf=0.1060876, min_samples_split=0.223397, n_estimators=43 | criterion='poisson', max_depth=2, max_samples=0.651752, min_samples_leaf=0.189317, min_samples_split=0.449878, n_estimators=23 |
| **AdaBoost**| learning_rate=1.562151, n_estimators=48                 | learning_rate=0.014532, n_estimators=110                   |
...
| **LGBM**    | class_weight='balanced', feature_fraction=0.489883, learning_rate=0.614967, max_depth=5, min_data_in_leaf=82, n_estimators=81, num_leaves=34, objective='binary' | feature_fraction=0.458930, learning_rate=0.082612, max_depth=1, min_data_in_leaf=2, n_estimators=18, num_leaves=28, objective='regression' |
| **MLP**     | activation='tanh', alpha=0.000544, hidden_layer_sizes=9, learning_rate='invscaling', learning_rate_init=0.007015, max_iter=486, momentum=0.994338, solver='lbfgs' | activation='logistic', alpha=0.000842, hidden_layer_sizes=14, learning_rate='adaptive', learning_rate_init=0.003694, max_iter=265, momentum=0.071646, solver='sgd' |
